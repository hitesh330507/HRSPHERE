...
public class EmployeeLifecycleIntegrationTest extends BaseIntegrationTest {
  ...
  void createEmployee_fullLifecycle() {
    ...
    departmentServiceMock.stubFor(get(urlEqualTo("/department/" + departmentId))
        .willReturn(okJson("{\"id\":\"" + departmentId + "\", \"name\":\"Engineering\"}")));

    // Step 1 — Create
    CreateEmployeeRequest createReq = EmployeeTestFixtures.validCreateRequest("lifecycle@example.com");
    ...
    ResponseEntity<EmployeeResponse> createResp = restTemplate.postForEntity(
        "/employees/create", createEntity, EmployeeResponse.class);
    ...
    ResponseEntity<ApiErrorResponse> duplicateResp = restTemplate.postForEntity(
        "/employees/create", createEntity, ApiErrorResponse.class);
    ...
    ResponseEntity<EmployeeResponse> getByIdResp = restTemplate.exchange(
        "/employees/" + created.id, HttpMethod.GET, new HttpEntity<>(empHdrs), EmployeeResponse.class);
    ...
    // Step 4 — Get by code
    ResponseEntity<EmployeeResponse> getByCodeResp = restTemplate.exchange(
        "/employees/code/" + created.employeeCode, HttpMethod.GET, new HttpEntity<>(empHdrs), EmployeeResponse.class);
    ...
    ResponseEntity<EmployeeResponse> updateResp = restTemplate.exchange(
    ...
    ResponseEntity<EmployeeResponse> termResp = restTemplate.exchange(
        "/employees/" + created.id + "/terminate", HttpMethod.PATCH, termEntity, EmployeeResponse.class);
    ...
    ResponseEntity<Map> listTermResp = restTemplate.exchange(
        "/employees/list?status=TERMINATED", HttpMethod.GET, new HttpEntity<>(validatedHdrs), Map.class);
    ...
    ResponseEntity<Map> listDefaultResp = restTemplate.exchange(
    ...
    ResponseEntity<ApiErrorResponse> getDeletedResp = restTemplate.exchange(
        "/employees/" + created.id, HttpMethod.GET, new HttpEntity<>(empHdrs), ApiErrorResponse.class);
  ...
  void createEmployee_roleEnforcement() {
    CreateEmployeeRequest createReq = EmployeeTestFixtures.validCreateRequest("role-enforce@example.com");
    ...
    ResponseEntity<ApiErrorResponse> createResp = restTemplate.postForEntity(
        "/employees/create", empEntity, ApiErrorResponse.class);
    ...
    createReq.departmentId = departmentId;
    ResponseEntity<EmployeeResponse> adminCreateResp = restTemplate.postForEntity(
        "/employees/create", new HttpEntity<>(createReq, adminHeaders()), EmployeeResponse.class);
    ...
    ResponseEntity<ApiErrorResponse> hrDeleteResp = restTemplate.exchange(
        "/employees/" + employeeId, HttpMethod.DELETE, new HttpEntity<>(hrHeaders()), ApiErrorResponse.class);
    ...
    updateReq.departmentId = departmentId;
    ResponseEntity<EmployeeResponse> hrUpdateResp = restTemplate.exchange(
        "/employees/" + employeeId, HttpMethod.PUT, new HttpEntity<>(updateReq, hrHeaders()), EmployeeResponse.class);
  ...
  void selfServiceUpdate_ownProfileOnly() {
    ...
    CreateEmployeeRequest createReq = EmployeeTestFixtures.validCreateRequest("self-service@example.com");
    ...
    ResponseEntity<EmployeeResponse> updateMeResp = restTemplate.exchange(
        "/employees/me", HttpMethod.PATCH, new HttpEntity<>(updateOwn, selfHdrs), EmployeeResponse.class);
  ...
  void selfServiceUpdate_noLinkedEmployee_returns404() {
    ...
    ResponseEntity<ApiErrorResponse> resp = restTemplate.exchange(
        "/employees/me", HttpMethod.PATCH, new HttpEntity<>(updateOwn, selfHdrs), ApiErrorResponse.class);
  ...
  void createEmployee_crossServiceDepartmentValidation() {
    ...
    departmentServiceMock.stubFor(get(urlEqualTo("/department/" + deptId))
        .willReturn(okJson("{\"id\":\"" + deptId + "\", \"name\":\"Engineering\"}")));

    CreateEmployeeRequest createReq = EmployeeTestFixtures.validCreateRequest("cross-dept@example.com");
    createReq.departmentId = deptId;

    ResponseEntity<EmployeeResponse> resp = restTemplate.postForEntity(
        "/employees/create", new HttpEntity<>(createReq, adminHeaders()), EmployeeResponse.class);
  ...
  void createEmployee_invalidDepartmentId_rejected() {
    UUID deptId = UUID.randomUUID();
    departmentServiceMock.stubFor(get(urlEqualTo("/department/" + deptId))
        .willReturn(notFound().withHeader("Content-Type", "application/json").withBody("{\"message\":\"Not found\"}")));

    CreateEmployeeRequest createReq = EmployeeTestFixtures.validCreateRequest("fake-dept@example.com");
    createReq.departmentId = deptId;

    ResponseEntity<ApiErrorResponse> resp = restTemplate.postForEntity(
        "/employees/create", new HttpEntity<>(createReq, adminHeaders()), ApiErrorResponse.class);
  ...
  void createEmployee_departmentServiceDown_proceedsGracefully() {
    ...
    CreateEmployeeRequest createReq = EmployeeTestFixtures.validCreateRequest("dept-down@example.com");
    createReq.departmentId = deptId;
  ...
  void validation_failures() {
    ...
    ResponseEntity<ApiErrorResponse> resp3 = restTemplate.exchange(
        "/employees/invalid-uuid", HttpMethod.GET, new HttpEntity<>(employeeHeaders("test")), ApiErrorResponse.class);
    assertThat(resp3.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);

    // Invalid enum in query param
    ResponseEntity<ApiErrorResponse> resp4 = restTemplate.exchange(
        "/employees/list?status=NOT_VALID_STATUS", HttpMethod.GET, new HttpEntity<>(employeeHeaders("test")), ApiErrorResponse.class);
  ...
  void pagination_and_filtering() {
    ...
    for (int i = 0; i < 5; i++) {
      CreateEmployeeRequest req = EmployeeTestFixtures.validCreateRequest("list-" + i + "@example.com");
      req.authUsername = "list-user-" + i;
      req.employmentType = types[i];
      req.departmentId = departmentId;
      ResponseEntity<EmployeeResponse> res = restTemplate.postForEntity(
    ...
    // Check totalElements (should be 3 FULL_TIME employees created in this test, plus possibly any others from other tests, so >= 3)
